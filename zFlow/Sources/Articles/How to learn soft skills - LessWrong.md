...
author:
  - AnnaSalamon
date_saved: 2023-03-07 12:59:19
date_published: 
url: https://www.lesswrong.com/posts/ZGzDNfNCXzfx6hYAH
omnivore_url: https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3
site_name: lesswrong.com
status: Unknown
tags:
  - highlights
  - source/article
...
# How to learn soft skills - LessWrong
...
As I read “[Bonds that Make Us Free](http://www.amazon.com/Bonds-That-Make-Free-Relationships/dp/1573459194)”, I read many explicit statements I disagreed with (such as statements about a Christian God). I took these in as poetry: I tried to imagine the world the author saw himself in, and to see myself in the same world, so as to have more access to the way he was parsing human phenomena. 
...
One way to try this is to read a book. But, since books’ usefulness is not just about their accuracy, it can \*also\* be surprisingly effective to just write your own book -- or, at least, to write 5 minutes of it. You can think of this as a way of getting system 1 unstuck from its default pattern.\[1\]
...
[_Bonds that Make Us Free_](http://www.amazon.com/Bonds-That-Make-Free-Relationships/dp/1573459194), by Terry Warner  
[_An Open Heart_](http://www.amazon.com/An-Open-Heart-Practicing-Compassion/dp/0316930938), by the Dalai Lama  
[_Feeling Good Together_](http://www.amazon.com/Feeling-Good-Together-Troubled-Relationships/dp/0767920821), by David Burns  
[_Eat That Frog_](http://www.amazon.com/Eat-That-Frog-Great-Procrastinating/dp/1576754227), by Brian Tracy  
[_How to Win Friends and Influence People_](http://www.amazon.com/How-Win-Friends-Influence-People/dp/0671027034), by Dale Carnegie  
[_Self-therapy_](http://www.amazon.com/Self-Therapy-Step-By-Step-Wholeness-Cutting-Edge-Psychotherapy/dp/0984392777), by Jay Earley   
[_Focusing_](http://www.amazon.com/Focusing/dp/B006H9RQ6Y), by Eugene Gendlin (the audiobook is much better than the paper, IMO)  
[_The Core LW Sequences_,](http://wiki.lesswrong.com/wiki/Sequences#Core%5FSequences) by Eliezer.
...
\[1\] System 1 stuckness of this sort seems to be almost ubiquitous. For example, I type and drive quite a bit, but my typing and driving skill are pretty similar to what they were several years ago; my conversational skills improve more, but they seem to have some of this same "trying the [same things](http://hpmor.com/chapter/68) again and again" flavor. In this context, even random noise seems helpful to jumpstart learning.

("[Learned blankness](https://www.lesswrong.com/lw/5a9/learned%5Fblankness/)" seems related here as well; one somehow gets stuck in an ontology; the goal of soft skills books is often to help a person jumpstart out of it.)
...
I'd nominate C.S. Lewis's _[The Screwtape Letters](http://www.amazon.com/gp/product/0060652934/ref=as%5Fli%5Fqf%5Fsp%5Fasin%5Fil%5Ftl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0060652934&linkCode=as2&tag=unequyoked-20&linkId=7BLSYWGSJPHCFOLB)_ as a soft skills book, that gives your System 1 a lot of vivid, specific ways human thinking goes wrong to chew on and find ways out of.

One of my favorite examples is this passage which made a _big_ impression on my System 1 about things that _do_ bore me but I nonetheless get sucked into. (Context note: Screwtape Letters is written as a series of letters from a senior devil to a junior tempter about how to lead human lives astray)
...
Now I don't have to write the LW article on this that I've been meaning to write for years. Thanks! ;-) (I might still write it, but now I don't _have to_.)
...
I wish it came with an explanation what \_exactly\_ Impatience and Hybris virtues entail (given that both are generally described as non-virtues but I do seem to have the feeling that they can be good; same works for Laziness, but here I believe I have better understanding already).
...
Here is an interesting [flowcharts](https://www.practicewise.com/Portals/0/Demo/match/depression/flowchart.html) related to depression. Not sure how to interpret them, but I suppose flowcharting mental health triggers and actions could be very useful.
...
Not true. At least not likely. If it were so, then most people would pick up soft skills in a rather automatic fashion without the need for too much conscious effort (actually, _any_ conscious effort, since if the inner simulator is more accurate, your intuitions should lead you on the correct/_correct-ish_ path. Ceterus Paribus, this should hold true for the majority of people (i would expect around more than 90%)
...
highlight:: Acquiring some skills is mostly about deliberate, explicit information transfer. [⤴️](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3#46f4b4e7-d299-4b61-bf47-62febec59b6f) #highlight

highlight:: For other skills, practitioners' skill rests largely on semi-conscious, non-explicit patterns of perception and action.  I have in mind here such skills as:
Managing your emotions and energy levels;
Building strong relationships;
Making robust plans;
Finding angles of attack on a mathematical problem;
Writing persuasively;
Thinking through charged subjects without bias; [⤴️](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3#a6164b14-c85a-454e-8edd-09ee68330800) #highlight

highlight::  [⤴️](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3#5bd9264d-392c-41c8-833b-3b9b75563140) #highlight

highlight:: textbooks are supposed to be made out of statements you can trust -- statements you can add to your file of “trusted explicit claims”, in such a fashion as to make you better [⤴️](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3#b3f59a57-8ac5-40e6-9d4d-fbf2c7fe95de) #highlight

highlight:: You can test ideas in your "inner simulator" [⤴️](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3#e9625883-8194-4571-ac32-3721508749e3) #highlight


---


[View in Omnivore](https://omnivore.app/me/how-to-learn-soft-skills-less-wrong-186bd3a46c3)
