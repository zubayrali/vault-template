...
var SmartRenameSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Update title key").setDesc("Update title key in frontmatter").addToggle((toggleComponent) => {
      toggleComponent.setValue(this.plugin.settings.shouldUpdateTitleKey).onChange(async (value) => {
        this.plugin.settings.shouldUpdateTitleKey = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian.Setting(containerEl).setName("Update first header").setDesc("Update first header if it is present in the document. May conflict with the `Filename Heading Sync` plugin").addToggle((toggleComponent) => {
      toggleComponent.setValue(this.plugin.settings.shouldUpdateFirstHeader).onChange(async (value) => {
  ...
  renderStoreInvalidTitleSettingEl(storeInvalidTitleSettingEl) {
    ...
    new import_obsidian.Setting(storeInvalidTitleSettingEl).setName("Store invalid title").setDesc("If enabled, stores title with invalid characters. If disabled, stores the sanitized version").addToggle((toggleComponent) => {
      toggleComponent.setValue(this.plugin.settings.shouldStoreInvalidTitle).onChange(async (value) => {
...
// src/SmartRenameSettings.ts
var SmartRenameSettings = class {
  constructor() {
    __publicField(this, "invalidCharacterAction", "Error" /* Error */);
    __publicField(this, "replacementCharacter", "_");
    __publicField(this, "shouldStoreInvalidTitle", true);
    __publicField(this, "shouldUpdateTitleKey", false);
    __publicField(this, "shouldUpdateFirstHeader", false);
  }
};
...
var PromptModal = class _PromptModal extends import_obsidian2.Modal {
  constructor(app, promptText) {
    super(app);
    __publicField(this, "resolve");
    __publicField(this, "promptText");
    __publicField(this, "value", "");
    __publicField(this, "isCancelled", true);
  ...
  static async getResult(app, promptText) {
    const modal = new _PromptModal(app, promptText);
...
var SmartRenamePlugin = class extends import_obsidian3.Plugin {
  constructor() {
    super(...arguments);
    __publicField(this, "systemForbiddenCharactersRegExp");
    __publicField(this, "obsidianForbiddenCharactersRegExp", /[#^[\]|]/g);
    __publicField(this, "currentNoteFile");
    __publicField(this, "oldTitle");
    __publicField(this, "newTitle");
    __publicField(this, "newPath");
    __publicField(this, "backlinksToFix", /* @__PURE__ */ new Map());
    __publicField(this, "isReadyToFixBacklinks");
  ...
  prepareBacklinksToFix() {
    ...
    for (const backlinkFilePath of Object.keys(backlinksData)) {
      ...
      for (let linkIndex = 0; linkIndex < links.length; linkIndex++) {
        ...
        const displayText = (_c = (_b = (_a = link.displayText) == null ? void 0 : _a.split(" > ")[0]) == null ? void 0 : _b.split("/")) == null ? void 0 : _c.pop();
